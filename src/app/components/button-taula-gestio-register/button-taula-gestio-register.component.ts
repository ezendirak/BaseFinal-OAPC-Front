...
@Component({
  selector: 'app-button-taula-gestio-register',
  templateUrl: './button-taula-gestio-register.component.html',
  styleUrls: ['./button-taula-gestio-register.component.css']
})
export class ButtonTaulaGestioRegisterComponent implements OnInit {
